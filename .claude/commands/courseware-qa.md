...
4. **Practice Exam** — **CERTIFICATION COURSES ONLY** (Microsoft, AWS, Google, Cisco, CompTIA, PMI, Oracle …). For these, the matching **Practice Exam from exams.tertiaryinfotech.com** must be surfaced on a **visual slide** with the exam link. **Non-certification courses do NOT have a practice exam — its absence is CORRECT and must NOT be reported as a defect.** Skills-based courses (Python, n8n, Excel, vibe coding, digital marketing …) are non-certification even when technical.
