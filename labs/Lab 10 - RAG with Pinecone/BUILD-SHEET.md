...
Flow: **`Lab 3 - RAG`** — trigger → HTTP → Compose → Agent → Response
...
{ "name": "cookbake-brochures", "cloud": "aws", "region": "us-east-1",
...
| Thing | Value |
|---|---|
| Index host | `cookbake-brochures-XXXXXX.svc.aped-4627-b74a.pinecone.io` |
