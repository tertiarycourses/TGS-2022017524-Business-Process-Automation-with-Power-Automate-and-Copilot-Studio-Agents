...
1. **Create → New agent** in your **Training Class** environment. Name it `Lab 9 - Blog Agent`.
...
In Lab 5 the Sales Agent was grounded by *giving* it the brochures. This agent is grounded by
