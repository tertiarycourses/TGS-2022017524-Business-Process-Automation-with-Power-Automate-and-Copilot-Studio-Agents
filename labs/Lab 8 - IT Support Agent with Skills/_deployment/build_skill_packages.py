#!/usr/bin/env python3
"""Build Copilot Studio skill packages for Labs 5 to 9 (every skills/ folder
under those three lab roots, including the going-further/ kits).
...
AGENT_ROOTS = [
    LABS_ROOT / "Lab 5 - Your First Agent",
    LABS_ROOT / "Lab 6 - Procurement Agent with Tools",
    LABS_ROOT / "Lab 7 - Sales Agent with Knowledge",
    LABS_ROOT / "Lab 8 - IT Support Agent with Skills",
    LABS_ROOT / "Lab 9 - Multi-Agent Content Team",
]
...
def main() -> None:
    ...
    for root in AGENT_ROOTS:
        ...
        for skill_md in sorted(root.rglob("skills/*/SKILL.md")):
            if "_packages" in skill_md.parts:
                continue
