...
Node 3 of `Module 4 - Human in the loop flow`. Paste the two blocks below into the Agent
...
Lab 2 put the firm's *facts* in a PDF and the firm's *rules* in the instruction,
