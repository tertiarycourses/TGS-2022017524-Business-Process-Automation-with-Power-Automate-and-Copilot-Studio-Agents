...
submission. Lab 4 is the first one where **a Copilot Studio agent decides to call the flow**,
...
`LU4 Lab 4 - Procurement Requisition Approval`.
...
5. In Lab 6 the duplicate check was a step in the flow and you could see it on the canvas. Here
