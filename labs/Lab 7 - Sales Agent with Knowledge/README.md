...
[Lab 15](../../Lab%2015%20-%20RAG%20with%20Knowledge%20Base/). The 20 course brochures are the agent's
knowledge.

**Pattern taught:** *grounding, and the discipline of not selling.* This is the only agent in Lab 5
...
> staff. Sales serves *customers*, and reusing Lab 15's brochures gives you 20 real documents with
...
| [`knowledge/brochures/`](knowledge/brochures/) | **The 20 course brochures**, copied from Lab 15 |
