...
1. **Create → New agent** in the **Copilot Studio Training** environment. Name it
...
5. **Connected agents → +** — add `Research Agent`, `Blog Agent`, `Review Agent`. Each must be
   **published** to appear.
6. **Memory** — leave **off** for the lab. (Extension: switch it on and see the Manager remember
   ...
   remember anything.)
7. **Publish**, then test from the **Preview** tab with the [test script](../README.md#test-script).
...
and the [flow-based gate extension](../README.md#where-the-human-review-really-is--read-this-before-teaching)
is the remedy.
