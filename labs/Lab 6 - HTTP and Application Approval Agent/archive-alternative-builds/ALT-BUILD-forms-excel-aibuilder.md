> **Archived, non-canonical build.** The course now teaches Lab 6 on Copilot Studio with
> SharePoint — see [`../README.md`](../README.md). This Microsoft Forms + Excel + AI Builder
