...
| [`connected-agents/`](./) | The four children, one folder each |
| [`webchat/`](../../../Lab%2017%20-%20Publish%20to%20Teams%2C%20Microsoft%20365%20Copilot%20and%20the%20Web/going-further/webchat/) | **Optional extension:** an HR intranet landing page with the agent as a chat widget, via the Microsoft 365 Agents SDK — the signed-in-user story on a web page |

### The four children

| # | Agent | Owns | Talks to |
|---|---|---|---|
| 1 | [Screening Agent](01%20-%20Screening%20Agent/) | Applications against role criteria | Recruiters |
| 2 | [Interview Agent](02%20-%20Interview%20Agent/) | Scheduling and interview packs | Hiring managers |
| 3 | [Onboarding Agent](03%20-%20Onboarding%20Agent/) | Day-one checklists, IT and access requests | New joiners, managers |
| 4 | [Policy and Benefits Agent](04%20-%20Policy%20and%20Benefits%20Agent/) | Leave, benefits, claims — the everyday questions | All staff |
...
[`connected-agents/03 - Onboarding Agent/`](03%20-%20Onboarding%20Agent/).
...
[`webchat/`](../../../Lab%2017%20-%20Publish%20to%20Teams%2C%20Microsoft%20365%20Copilot%20and%20the%20Web/going-further/webchat/) puts the published HR Agent on a Keppel Ridge intranet landing page as a
